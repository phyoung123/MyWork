...
def set_fig_properties(ax_list):
    ...
    for ax in ax_list:
        ...
        ax.tick_params(axis='both', direction='in', right=False, top=False)
...
xlabel('group index', font='Arial')
ylabel('Temperature (K)', font='Arial')
plt.text(1.5, 3190, '(a)', size=20, font='Arial')
# title('(a)')
...
xlabel('time (ns)', font='Arial')
ylabel('Heat (keV)', font='Arial')
ax=plt.gca()
y_major_locator=MultipleLocator(30)
ax.yaxis.set_major_locator(y_major_locator)
plt.text(0, 75, '(b)', size=20, font='Arial')
# title('(b)')
tight_layout()
savefig('Q.jpg', bbox_inches='tight', dpi=600)
...
#     fo.write("{}  {}  {}  {}\n".format(833, Lx, mean_Q, mean_Q_error))
